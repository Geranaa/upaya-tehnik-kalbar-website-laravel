    ...
    <section class="hero-section">
        <div class="hero-content">
            <div class="container">
                ...
                <div class="content">
                    <p>
                        Provisioning Type-3 (PT3)/Project adalah proses penyediaan suatu layanan jaringan FFTH yang
                        mencakup persiapan material, aksesoris dan alat untuk pemasangan Optical Distribution Point
                        (ODP) baru, penarikan drop cable sampai ke Optical Termination Premises (OTP).
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="gallery-section">
        ...
        <div class="photo-gallery">
            ...
            <div class="photo-display">
                ...
                <img id="main-photo" src="../image/project/photo_6053389575306463486_y.jpg" alt="Foto Utama">
                <button class="arrow right-arrow" onclick="nextPhoto()">&#9654;</button>
            </div>

            <div class="photo-thumbnails">
                <img src="../image/project/photo_6053389575306463487_y.jpg" alt="Thumbnail 1"
                    onclick="displayPhoto(this)">
                <img src="../image/project/photo_6053389575306463492_y.jpg" alt="Thumbnail 2"
                    onclick="displayPhoto(this)">
                <img src="../image/project/photo_6053389575306463488_y.jpg" alt="Thumbnail 3"
                    onclick="displayPhoto(this)">
                <img src="../image/project/photo_6053389575306463489_y.jpg" alt="Thumbnail 4"
                    onclick="displayPhoto(this)">
                <img src="../image/project/photo_6053389575306463491_y.jpg" alt="Thumbnail 5"
                    onclick="displayPhoto(this)">
                <img src="../image/project/photo_6053389575306463493_y.jpg" alt="Thumbnail 6"
                    onclick="displayPhoto(this)">
            </div>
        </div>
    </section>
