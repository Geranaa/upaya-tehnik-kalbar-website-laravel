...
<head>
    ...
    <link rel="stylesheet" href="/css/style_ioan.css">
...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <div class="container">
                ...
                <div class="content">
                    <p>
                        Assurance atau IOAN (Integrated Operation Access Network) yang merupakan unit kerja di PT Telkom
                        Akses yang bertugas untuk mengatasi gangguan Indihome.
                        Assurance juga bertanggung jawab untuk melakukan perawatan terhadap aset, baik perawatan
                        korektif, preventif, emergency, maupun predictive maintenance.
                    </p>
    ...
    <section class="staff-section">
        <div class="staff-title">
            <h1>Staff Divisi Layanan Assurance</h1>
        </div>
        <br>
        ...
        <div class="staff-container">
            <script>
                const maxSlide = 8;
                if {
                    karyawanIoan > maxSlide
                } {

                }
            </script>
            @if ($karyawanIoan->isEmpty())
                <h1 style="color: gray">Tidak ada data Pegawai</h1>
            @else
                @foreach ($karyawanIoan as $staff)
    ...
    <section class="gallery-section">
        ...
        <div class="photo-gallery">
            ...
            <div class="photo-display">
                ...
                <img id="main-photo" src="../image/ioan/6075823357724574879.jpg" alt="Foto Utama">
                <button class="arrow right-arrow" onclick="nextPhoto()">&#9654;</button>
            </div>

            <div class="photo-thumbnails">
                <img src="../image/ioan/6075483947934008251.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6075483947934008252.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6075483947934008253.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6075823357724574883.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6075823357724574884.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6078068006417712642.jpg" alt="Thumbnail 1" onclick="displayPhoto(this)">
                <img src="../image/ioan/6078068006417712643.jpg" alt="Thumbnail 4" onclick="displayPhoto(this)">
            </div>
        </div>
    </section>
