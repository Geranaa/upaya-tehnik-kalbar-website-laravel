...
<head>
    ...
    <link rel="stylesheet" href="/css/style_provi.css">
...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <div class="container">
                ...
                <div class="content">
                    <p>
                        Provisioning Type-1 (PT1) atau PSB adalah pekerjaan instalasi dan aktivasi layanan IndiHome
                        bagi pelanggan baru. Pekerjaan ini meliputi:
                        Instalasi jaringan baru fiber optik (FO), Pemasangan Access Point (AP),
                        Pemasangan perangkat Internet of Things (IoT).
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="staff-section">
        <div class="staff-title">
            <h1>Staff Divisi Layanan Provisioning</h1>
        </div>
        <br>
        <button class="nav-button left" id="prev">&#8249;</button>
        <div class="staff-container">
            @if ($karyawanProvi->isEmpty())
                <h1 style="color: gray">Tidak ada data Pegawai</h1>
            @else
                @foreach ($karyawanProvi as $staff)
    ...
    <section class="gallery-section">
        ...
        <div class="photo-gallery">
            ...
            <div class="photo-display">
                ...
                <img id="main-photo" src="../image/provi/photo_6339101326801223882_y.jpg" alt="Foto Utama">
                <button class="arrow right-arrow" onclick="nextPhoto()">&#9654;</button>
            </div>

            <div class="photo-thumbnails">
                <img src="../image/provi/photo_6339101326801223883_y.jpg" alt="Thumbnail 1"
                    onclick="displayPhoto(this)">
                <img src="../image/provi/photo_6339101326801223884_y.jpg" alt="Thumbnail 2"
                    onclick="displayPhoto(this)">
                <img src="../image/provi/photo_6339101326801223885_y.jpg" alt="Thumbnail 3"
                    onclick="displayPhoto(this)">
                <img src="../image/provi/photo_6339101326801223886_y.jpg" alt="Thumbnail 4"
                    onclick="displayPhoto(this)">
                <img src="../image/provi/photo_6339101326801223887_y.jpg" alt="Thumbnail 5"
                    onclick="displayPhoto(this)">
                <img src="../image/provi/photo_6339101326801223889_y.jpg" alt="Thumbnail 6"
                    onclick="displayPhoto(this)">
            </div>
        </div>
    </section>
